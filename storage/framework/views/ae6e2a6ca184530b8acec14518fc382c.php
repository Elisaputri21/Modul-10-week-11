...
<body>
    <!-- Navbar -->
    <nav class="navbar fixed-top navbar-expand-lg bg-ungu" data-bs-theme="dark">
        <div class="container py-2 px-4">
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/logo-white.svg')); ?>" alt="logo"
                    style="width: 40px" />
            </a>
            ...
            <div class="offcanvas offcanvas-end bg-ungu" id="offcanvasNavbar">
                        ...
                        <li class="nav-item">
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <button class="dropdown-item active bg-ungu" type="button">
                ...
                <div class="col-md-7 md-1">
                    ...
                    <div class="row">
                        <div class="d-flex flex-column flex-md-row">
                            <button type="button" class="btn bg-ungu text-white btn-lg mb-3 me-md-3 px-4 py-3">
                                Get Started
                            </button>
                    ...
                    <div class="text-muted">
                        ...
                        <a href="#" class="link-diam">v4.6.x docs</a> · <a href="#"
                            class="link-diam">All releases</a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p class="fs-5">
                            ...
                            use Bootstrap itself or not. Use them as SVGs or icon fonts—both
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/bs-icons.png')); ?>"
                            alt="Bootstrap Icons" />
                    </div>
                </div>
            </div>
        ...
        <div id="bs-themes">
            <div class="container py-5 px-4">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/bs-themes.png')); ?>"
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/logo-black.svg')); ?>"
...
<?php /**PATH C:\Users\Lenovo\OneDrive\Documents\KULIAH\Pemrograman Framework\Modul 03\ujicoba\resources\views/view_cloningbootstrap.blade.php ENDPATH**/ ?>